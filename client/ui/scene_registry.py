...
def register_all_scenes(default_user=None):
    ...
    from .GachaScene import GachaScene
    ...
    def gacha_factory(screen, user_data=None, **kw):
        return GachaScene(screen, user_data=user_data or default_user)
    ...
    def battle_factory(screen, user_data=None, **kw):
        p2p = kw.get('p2p_battle')
        return BattleScene(screen, user_data=user_data, p2p_battle=p2p)
    ...
    register_scene('gacha', gacha_factory)